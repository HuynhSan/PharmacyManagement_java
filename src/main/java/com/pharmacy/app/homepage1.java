...
// cardlayout
    ...
    private void minmaxiconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minmaxiconMouseClicked
        ...
        if (this.getExtendedState() != homepage1.MAXIMIZED_BOTH){
            this.setExtendedState(homepage1.MAXIMIZED_BOTH);
            }
        else {
            this.setExtendedState(homepage1.NORMAL);
        }
...
// Phân quyền
    ...
    public static void main(String args[]) {
        ...
        /* Create and display the form */
         SwingUtilities.invokeLater(() -> new homepage1().setVisible(true));
    }
