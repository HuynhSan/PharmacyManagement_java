...
public class PromoDetail extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cbxPromotionType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Điểm tích lũy", "Mặt hàng" }));
    ...
    private void fillFields(Promotion promo) {
        ...
        cbxPromotionType.setSelectedItem(promo.getPromotionType());
        cbxProduct.setSelectedItem(promo.getProduct());
        txtDiscountPercent.setText(String.valueOf(promo.getDiscountPercent()));
        txtMinAccumulatedPoint.setText(String.valueOf(promo.getMinAccumulatedPoints()));
        txtDiscountAmount.setText(String.valueOf(promo.getDiscountAmount()));

//        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        
        if (promo.getStartDate() != null){
            dateStart.setDate(promo.getStartDate());
        }
        if (promo.getEndDate()!= null){
            dateEnd.setDate(promo.getEndDate());
        }
}
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(PromoDetail.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
